      ...
      (e.startTransition = function (e) {
        ...
        try {
          var r = e(),
            i = S.S;
          (i !== null && i(n, r),
            typeof r == `object` && r && typeof r.then == `function` && r.then(te, T));
        } catch (e) {
          T(e);
        } finally {
      ...
      (e.unstable_scheduleCallback = function (r, i, a) {
        ...
        return (
          ...
          a > o
            ? ((r.sortIndex = a),
              t(l, r),
              n(c) === null && r === n(l) && (h ? (v(te), (te = -1)) : (h = !0), oe(x, a - o)))
...
` +
    ...
    function xi(e, t, n, r, a, o) {
      ...
      if (((r = e), typeof e == `function`)) vi(e) && (s = 1);
        ...
        a: switch (e) {
          case w:
            return ((e = _i(31, n, t, a)), (e.elementType = w), (e.lanes = o), e);
          case y:
          ...
          case ne:
            return ((e = _i(13, n, t, a)), (e.elementType = ne), (e.lanes = o), e);
          case re:
            return ((e = _i(19, n, t, a)), (e.elementType = re), (e.lanes = o), e);
          default:
    ...
    function Wa(e) {
      ...
      function l(e, t, n, r) {
        ...
        return i === y
          ...
          : t !== null &&
              (t.elementType === i ||
                (typeof i == `object` && i && i.$$typeof === C && Fa(i) === t.type))
...
`,
  ...
  x = `#d50000`,
  ee = class extends _.Component {
    selectCard = () => {
      this.props.selectCardFn(this.props.objKey);
    };
    handleKeyDown = (e) => {
      (e.key === `Enter` || e.key === ` ` || e.key === `Spacebar`) &&
        (e.preventDefault(), this.selectCard());
    };
    getDisplayValue = (e) => {
      let t = e + 1;
      if (t > 1 && t <= 10) return t.toString();
      switch (t) {
        case 1:
          return `A`;
        case 11:
    ...
    getCardName = () => `${y[this.props.rank]} of ${b[this.props.suit]}`;
    render() {
      let e = this.props.interactive !== !1,
        t = this.getCardName(),
        n = e ? t : `${t}, covered`;
      return _.createElement(
        `div`,
        {
          ...
          onKeyDown: e ? this.handleKeyDown : void 0,
          role: e ? `button` : `img`,
          tabIndex: e ? 0 : -1,
          "aria-label": n,
          "aria-pressed": e ? !!this.props.selected : void 0,
          style: {
            boxSizing: `border-box`,
            border: this.props.selected ? `2px solid ${x}` : `1px solid grey`,
            textAlign: `left`,
            borderRadius: 10,
            height: this.props.height,
            width: this.props.width,
            padding: 5,
            color: this.props.suit === `♥` || this.props.suit === `♦` ? x : `black`,
        ...
        _.createElement(
          ...
          {
            "aria-hidden": `true`,
            style: { marginTop: this.props.height - 55, textAlign: `right` },
          },
          this.getDisplayValue(this.props.rank),
          this.props.suit,
        ),
  ...
  te = class extends _.Component {
    handleSelectEmpty = () => {
      this.props.card === null && this.props.selectEmptySquareFn(this.props.location);
    };
    handleKeyDown = (e) => {
      (e.key === `Enter` || e.key === ` ` || e.key === `Spacebar`) &&
        (e.preventDefault(), this.handleSelectEmpty());
    };
    render() {
      let e = this.props.card === null,
        t = Number(String(this.props.location).replace(/\D/g, ``)) + 1,
        n = !!this.props.selectedCardName,
        r = e
          ? n
            ? {
                role: `button`,
                tabIndex: 0,
                "aria-label": `Move ${this.props.selectedCardName} to free cell ${t}`,
                onKeyDown: this.handleKeyDown,
              }
            : { role: `img`, "aria-label": `Free cell ${t}, empty` }
          : {};
      return _.createElement(
        `div`,
        {
  ...
  S = class extends _.Component {
    handleSelectEmpty = () => {
      this.props.cards.length || this.props.selectEmptySquareFn(this.props.location);
    };
    handleKeyDown = (e) => {
      (e.key === `Enter` || e.key === ` ` || e.key === `Spacebar`) &&
        (e.preventDefault(), this.handleSelectEmpty());
        ...
        r = e
          ? n
            ? {
                role: `button`,
                tabIndex: 0,
                "aria-label": `Move ${this.props.selectedCardName} to foundation ${t}`,
                onKeyDown: this.handleKeyDown,
              }
            : { role: `img`, "aria-label": `Foundation ${t}, empty` }
          : {};
      return _.createElement(
        `div`,
        {
  ...
  ne = class extends _.Component {
    ...
    cardColor = (e) => (e.suit === `♦` || e.suit === `♥` ? `red` : `black`);
    firstSelectableIndex = (e) => {
      let t = e.length - 1;
      for (let n = e.length - 2; n >= 0; n--) {
        let r = e[n],
          i = e[n + 1];
        if (i.rank === r.rank - 1 && this.cardColor(r) !== this.cardColor(i)) t = n;
        else break;
      }
      return t;
    };
    render() {
      let e = -this.props.cardHeight + Math.round(0.33 * this.props.cardHeight),
        t = !this.props.cards.length,
        n = this.props.cards.length ? this.firstSelectableIndex(this.props.cards) : 0,
        r = Number(String(this.props.location).replace(/\D/g, ``)) + 1,
        i = !!this.props.selectedCardName,
        a = t
          ? i
            ? {
                role: `button`,
                tabIndex: 0,
                "aria-label": `Move ${this.props.selectedCardName} to tableau column ${r}`,
                onKeyDown: this.handleKeyDown,
              }
            : { role: `img`, "aria-label": `Tableau column ${r}, empty` }
          : {};
      return _.createElement(
        `div`,
        {
          ...
          style: {
            paddingTop: -e,
            paddingLeft: this.props.cardMargins / 2,
  ...
  se = class extends _.Component {
    ...
    generateCards = () => {
      ...
      (re.forEach((t) => {
        for (let n = 0; n <= 12; n++)
          e[n + t] = { suit: t, rank: n, location: null, selected: !1, objKey: n + t };
      }),
        this.setState({ cards: e }, () => {
          this.shuffleCards();
        }));
    };
    shuffleCards = () => {
      let e = [];
      re.forEach((t) => {
        for (let n = 0; n <= 12; n++) e.push({ suit: t, rank: n });
      });
      let t = e
          .map((e) => ({ sortValue: Math.random(), value: e }))
          .sort((e, t) => e.sortValue - t.sortValue)
          .map((e) => e.value),
        n = { ...this.state.cards };
      (t.forEach((e, t) => {
        let r = t % 8,
          i = Math.floor(t / 8),
          a = e.rank + e.suit;
        ((n[a].location = `cascade`), (n[a].column = r), (n[a].position = i));
      }),
        this.setState({ cards: n }, () => {
          this.displayCards();
        }));
    };
    cardsCanStack = (e, t, n) => {
      let r = this.state.cards[e],
        i = this.state.cards[t];
      return n === `cascade`
        ? !(i.rank - 1 !== r.rank || this.getCardColor(i) === this.getCardColor(r))
        : n === `foundation`
          ? !(i.suit !== r.suit || i.rank + 1 !== r.rank)
          : (console.error(
    ...
    gameWon = () => {
      (this.announce(`You win! All cards are on the foundations.`), alert(`YOU WIN!!!`));
    };
    displayCards = () => {
      let e = { ...this.state.cards },
        t = [[], [], [], [], [], [], [], []],
        n = [[], [], [], []],
      ...
      for (let a in e) {
        let o = e[a];
        o.location === `cascade`
          ? ((t[o.column][o.position] = o), (i = !1))
          : o.location === `foundation`
            ? (n[o.column][o.position] = o)
            : o.location === `freeCell` && ((r[o.column] = o), (i = !1));
      }
      (this.setState(
        { cards: e, cascades: t, foundations: n, freeCells: r, selectedKey: null, gameWon: i },
        () => {
          let e = this.focusKeyAfterUpdate;
          if (((this.focusKeyAfterUpdate = null), e)) {
    ...
    selectEmptySquareFn = (e) => {
      let t = this.state.selectedKey;
      if (!t) return;
      let n = e.match(/(\w+)(\d+)/);
      if (!n) return;
      let r = n[1],
        i = Number(n[2]),
        a = this.getCascadeRun(t);
      if (r === `foundation`) {
        if (a.length > 1) {
          this.announce(`Only a single card can move to a foundation.`);
          return;
        }
        this.tryToStackCardOnFoundation({ cardKey: t, column: i }) ||
          this.announce(`${w(this.state.cards[t])} cannot move to foundation ${i + 1}.`);
      } else if (r === `freeCell`) {
        if (a.length > 1) {
          this.announce(`Only a single card can move to a free cell.`);
          return;
        }
        this.checkToMoveToFreeCell({ cardKey: t, column: i });
      } else
        r === `cascade` &&
          (this.tryToMoveRunToCascade({ runKeys: a, column: i }) ||
            this.announce(`${w(this.state.cards[t])} cannot move to tableau column ${i + 1}.`));
    };
    selectCardFn = (e) => {
      let t = { ...this.state.cards };
      if (this.state.selectedKey && this.state.selectedKey === e) {
        let n = this.getCascadeRun(this.state.selectedKey);
        if (
          n.length <= 1 &&
          (this.tryToStackCardOnFoundation({ cardKey: this.state.selectedKey, column: 0 }) ||
            this.tryToStackCardOnFoundation({ cardKey: this.state.selectedKey, column: 1 }) ||
            this.tryToStackCardOnFoundation({ cardKey: this.state.selectedKey, column: 2 }) ||
            this.tryToStackCardOnFoundation({ cardKey: this.state.selectedKey, column: 3 }))
        )
          return;
        (n.forEach((e) => {
          t[e].selected = !1;
        }),
          this.setState({ cards: t, selectedKey: null }),
          this.announce(`Deselected ${w(t[e])}.`));
        return;
      }
      if (!this.state.selectedKey) {
        let n = t[e];
        if (n.location === `cascade`) {
          let r = this.getCascadeRun(e);
          if (!this.isValidSequence(r)) {
            this.announce(`${w(n)} is not the top of a movable sequence.`);
            return;
          }
          (r.forEach((e) => {
            t[e].selected = !0;
          }),
            this.setState({ cards: t, selectedKey: e }),
            this.announce(
              r.length > 1
                ? `Selected ${r.length} cards from ${w(n)}. Choose where to move them.`
                : `Selected ${w(n)}. Choose where to move it.`,
            ));
          return;
        }
        ((t[n.objKey].selected = !0),
          this.setState({ cards: t, selectedKey: n.objKey }),
          this.announce(`Selected ${w(n)}. Choose where to move it.`));
        return;
      }
      let n = this.state.cards[this.state.selectedKey],
        r = this.state.cards[e],
        i = this.getCascadeRun(this.state.selectedKey);
      if (r.location === `foundation`) {
        if (i.length > 1) {
          this.announce(`Only a single card can move to a foundation.`);
          return;
        }
        let e = r.column;
        this.tryToStackCardOnFoundation({ cardKey: this.state.selectedKey, column: e }) ||
          this.announce(`${w(n)} cannot move to foundation ${e + 1}.`);
        return;
      } else if (r.location === `cascade`) {
        let e = r.column,
          t = this.state.cascades[e].length === 0;
        if (i.length > this.maxMovableCards(t)) {
          this.announce(
            `Not enough free cells or empty columns to move ${i.length} cards at once.`,
          );
          return;
        }
        this.tryToMoveRunToCascade({ runKeys: i, column: e }) ||
          this.announce(`${w(n)} cannot move to tableau column ${e + 1}.`);
      }
    };
    moveCard = (e) => {
      let { cardKey: t, location: n, column: r, position: i } = e,
        a = { ...this.state.cards },
        o = a[t];
      ((o.location = n),
        (o.column = r),
        (o.position = i),
        (o.selected = !1),
        this.state.selectedKey && (a[this.state.selectedKey].selected = !1),
        (this.focusKeyAfterUpdate = t),
        this.announce(`Moved ${w(o)} to ${ae(n, r)}.`),
        this.setState({ cards: a, selectedKey: null }, () => {
          this.displayCards();
        }));
    };
    checkToMoveToFreeCell = (e) => {
      let { cardKey: t, column: n } = e;
      if (this.state.freeCells[n]) {
        console.error(`Attempted to move to non-empty freeCell which should not be possible.`);
        return;
      }
      this.moveCard({ cardKey: t, location: `freeCell`, column: n, position: 0 });
    };
    tryToStackCardOnFoundation = (e) => {
      let { cardKey: t, column: n } = e,
        r = { ...this.state.cards },
        i = r[t];
      if (this.state.foundations[n].length === 0) {
        if (i.rank !== 0) return !1;
      } else {
        let e = this.state.foundations[n].length,
          t = this.state.foundations[n][e - 1];
        if (i.suit !== t.suit || i.rank - 1 !== t.rank) return !1;
      }
      return (
        this.moveCard({ cardKey: t, location: `foundation`, column: n, position: r[t].rank }), !0
      );
    };
    tryToMoveToEmptyCascade = (e) => {
      let { cardKey: t, column: n } = e;
      return this.state.cascades[n].length > 0
        ? (console.error(`Attempted to move to non-empty cascade, which should not be possible`),
          !1)
        : (this.moveCard({ cardKey: t, location: `cascade`, column: n, position: 0 }), !0);
    };
    tryToMoveToCascade = (e) => {
      let { cardKey: t, column: n } = e,
        r = { ...this.state.cards }[t],
        i = this.state.cascades[n].length,
        a = this.state.cascades[n][i - 1];
      return this.getCardColor(r) === this.getCardColor(a) || r.rank + 1 !== a.rank
        ? !1
        : (this.moveCard({ cardKey: t, location: `cascade`, column: n, position: a.position + 1 }),
          !0);
    };
    moveRun = (e, t, n, r) => {
      let i = { ...this.state.cards };
      (e.forEach((e, a) => {
        let o = i[e];
        ((o.location = t), (o.column = n), (o.position = r + a), (o.selected = !1));
      }),
        (this.focusKeyAfterUpdate = e[0]));
      let a = i[e[0]];
      (e.length > 1
        ? this.announce(`Moved ${e.length} cards from ${w(a)} to ${ae(t, n)}.`)
        : this.announce(`Moved ${w(a)} to ${ae(t, n)}.`),
        this.setState({ cards: i, selectedKey: null }, () => {
          this.displayCards();
        }));
    };
    tryToMoveRunToCascade = (e) => {
      let { runKeys: t, column: n } = e,
        r = this.state.cascades[n],
        i = r.length === 0;
      if (t.length > this.maxMovableCards(i)) return !1;
      let a = this.state.cards[t[0]];
      if (!i) {
        let e = r[r.length - 1];
        if (this.getCardColor(a) === this.getCardColor(e) || a.rank + 1 !== e.rank) return !1;
      }
      return (this.moveRun(t, `cascade`, n, r.length), !0);
    };
    getCardColor = (e) => (e.suit === `♦` || e.suit === `♥` ? `red` : `black`);
    getCascadeRun = (e) => {
      let t = this.state.cards[e];
      if (!t || t.location !== `cascade`) return [e];
      let n = this.state.cascades[t.column],
        r = n.findIndex((t) => t.objKey === e);
      return r === -1 ? [e] : n.slice(r).map((e) => e.objKey);
    };
    isValidSequence = (e) => {
      for (let t = 0; t < e.length - 1; t++) {
        let n = this.state.cards[e[t]],
          r = this.state.cards[e[t + 1]];
        if (r.rank !== n.rank - 1 || this.getCardColor(r) === this.getCardColor(n)) return !1;
      }
      return !0;
    };
    maxMovableCards = (e) => {
      let t = this.state.freeCells.filter((e) => e === null).length,
        n = this.state.cascades.filter((e) => e.length === 0).length;
      return (e && n > 0 && --n, (t + 1) * 2 ** n);
    };
    render() {
      let e = Math.min(Math.round(this.state.width / 12), Math.round(this.state.height / 12)),
        t = Math.round(1.4 * e),
        n = Math.round(this.state.width * 0.02),
        r = this.state.selectedKey ? this.state.cards[this.state.selectedKey] : null,
        i = r ? w(r) : null;
      return _.createElement(
        `div`,
        ...
        _.createElement(
          `p`,
          { style: oe },
          `To move a card, focus it and press Enter or Space to select it, then focus the destination card or empty slot and press Enter or Space again. Press Enter on a selected card to send it to a foundation.`,
        ),
        _.createElement(
          `div`,
          { "aria-live": `assertive`, "aria-atomic": `true`, style: oe },
          this.state.announcement,
        ),
        _.createElement(
          `button`,
          { style: { marginLeft: 20 }, onClick: this.generateCards },
          `New Game`,
        ),
        _.createElement(
          `span`,
        ...
        _.createElement(
          ...
          _.createElement(
            `div`,
            { style: { margin: n }, role: `group`, "aria-label": `Foundations` },
            _.createElement(
              `h2`,
            ...
            _.createElement(
              `div`,
              { style: { display: `flex` } },
              this.state.foundations.map((r, a) =>
                _.createElement(S, {
                  height: t,
                  width: e,
                  key: `foundation` + a,
                  location: `foundation` + a,
          ...
          _.createElement(
            `div`,
            { style: { margin: n }, role: `group`, "aria-label": `Free cells` },
            _.createElement(
              `h2`,
              { style: { textAlign: `center`, fontSize: `1rem` } },
              `FreeCells`,
        ...
        _.createElement(`h2`, { style: oe }, `Tableau`),
        _.createElement(
          `div`,
          {
            style: { display: `flex`, justifyContent: `center` },
...
function ce() {
  return _.createElement(
    ...
    _.createElement(
      `a`,
      { href: `https://scotteratigan.github.io/`, target: `_blank`, rel: `noopener noreferrer` },
      `My Portfolio`,
    ),
    ` `,
    `|`,
...
var le = class extends _.Component {
  render() {
    return _.createElement(
      _.Fragment,
      null,
      _.createElement(
        ...
        _.createElement(`h1`, null, _.createElement(`em`, null, `React`), `Cell`),
        _.createElement(
          `p`,
          { style: { fontWeight: `bold`, margin: `0.5em 0` } },
          `A FreeCell clone by Scott Ratigan`,
        ),
      ),
      _.createElement(`main`, { "aria-label": `FreeCell game board` }, _.createElement(se, null)),
      _.createElement(ce, null),
    );
  }
};
(0, v.createRoot)(document.getElementById(`root`)).render(_.createElement(le));
